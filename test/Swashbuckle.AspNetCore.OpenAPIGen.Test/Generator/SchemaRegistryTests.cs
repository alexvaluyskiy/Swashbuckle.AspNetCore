...
using Swashbuckle.AspNetCore.OpenAPIGen.Test;
using Xunit;
...
namespace Swashbuckle.AspNetCore.OpenAPIGen.Test
{
    public class SchemaRegistryTests
    {
        ...
        public void GetOrRegister_SupportsOptionToCustomizeSchemaIds()
        {
            ...
            var jsonReference1 = subject.GetOrRegister(typeof(OpenAPIGen.Test.Namespace1.ConflictingType));
            var jsonReference2 = subject.GetOrRegister(typeof(OpenAPIGen.Test.Namespace2.ConflictingType));
